...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className="calm-intro" aria-labelledby="calm-intro-title">
        <div className="site-container calm-intro-grid">
          <div>
            <p className="eyebrow">A traditional broker, moving forward</p>
            <h2 id="calm-intro-title">Professional where it matters. Approachable where it helps.</h2>
          </div>
          <div className="calm-intro-copy">
            <p>
      ...
      <section className="service-editorial" aria-labelledby="services-title">
        <div className="site-container service-editorial-grid">
          <div className="service-editorial-heading">
            <p className="eyebrow">What we do</p>
            <h2 id="services-title">Market access supported by research and accountable service.</h2>
            <Link href="/services">
              View all services
              <ArrowRight size={16} aria-hidden="true" />
            </Link>
      ...
      <section className="research-feature" aria-labelledby="research-title">
        <div className="site-container research-feature-grid">
          ...
          <div className="research-feature-copy">
            ...
            <h2 id="research-title">Useful market knowledge should be easy to find.</h2>
            <p>
            ...
            {featured ? (
              <Link href={`/insights/${featured.slug}`} className="featured-insight-link">
            ...
            <div className="research-feature-links">
      ...
      <section className="pathway-section" aria-labelledby="pathways-title">
        <div className="site-container">
          <div className="pathway-heading">
            <p className="eyebrow">Find what matters to you</p>
            <h2 id="pathways-title">Different investors should not have to navigate the same way.</h2>
          </div>
      ...
      <section className="latest-section" aria-labelledby="latest-title">
        <div className="site-container latest-grid">
          <div className="latest-heading">
            <p className="eyebrow">Latest from CGSI</p>
            <h2 id="latest-title">Research that respects your time.</h2>
            <p>
